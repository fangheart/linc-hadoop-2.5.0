...
public class FiCaSchedulerApp extends SchedulerApplicationAttempt {
  ...
  synchronized public boolean containerCompleted(RMContainer rmContainer,
    ...
    MajorServer.getInstance().updateContainerRunningTime(rmContainer.getApplicationAttemptId().toString(), rmContainer.getContainerId().toString(), rmContainer.getAllocatedNode().getHost());
